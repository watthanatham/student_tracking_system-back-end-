...
Student_Result.getAllStudentResult = (result) => {
    dbCon.query('SELECT stu_uid, stu_firstname, stu_lastname, sr_year, sr_term, sr_grade FROM  student INNER JOIN student_result ON student.stu_id = student_result.stu_id', (err, res) => {
        if(err) {
...
Student_Result.getStudentResultById = (id, result) => {
    dbCon.query('SELECT stu_uid, stu_firstname, stu_lastname, sr_year, sr_term, sr_grade FROM  student INNER JOIN student_result ON student.stu_id = student_result.stu_id WHERE sr_id=?', id, (err, res) => {
        if(err) {
